...
export default function NavBar({children,children1}) {
    ...
    return (
        <>
            ...
            <div className='flex bg-[#AF75BF] items-center justify-center h-16 text-lg md:text-2xl' >
                <ul className='lg:gap-48 md:gap-16 flex gap-8 text-white'>
            ...
            <div className='flex flex-col justify-center items-center mt-10 mb-8 gap-10'>
                ...
                <p className='mont text-black text-center text-2xl italic w-2/3 md:w-1/2'>{children1}</p>
